      ...
      <div className="portfolio-content">
        <div className="portfolio-item-individual">
          ...
          <p>
            ...
            crowd-funded projects. Building owners can create projects that need
            rehabilitating. Students can view and apply to work on available
            projects. Visitors can browse and make donations to revitalize
            projects.
          </p>

          <p className="portfolio-item__subheader">Tech Stack</p>
          <p>
            We used Figma to collaborate on the custom design. The front-end was
            built using React. For styling we used Styled Components and SASS.
            The back-end was built using GraphQL, Apollo, Prisma. It was stored
            in a Docker container and hosted on Heroku.
          </p>

          <p className="portfolio-item__subheader">build process</p>
          <p>
            ReVitalize was built by a team of 7 engineers and 2 designers led by
            a project manager. My Role was Front-End Developer. It was built in
            2 sprints, with each sprint lasting 2 weeks. As team we held daily
            stand-ups. Engineers were assigned tickets from the project manager
            and pair-programmed to complete tasks. We used Notion for
            documentation and to track tickets.
          </p>

          <p className="portfolio-item__subheader">End Result</p>
          <p>
            Working on ReVitalize was an amazing experience. It provided me with
            experience in a real world environment building a complex app that
            had an impact on communities. You can{' '}
            <a
              className="styled__link"
              href="https://revitalizecommunity.netlify.app/"
              onClick="window.open(this.href); return false;"
